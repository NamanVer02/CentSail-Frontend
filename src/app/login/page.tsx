...
export default function LoginPage() {
  ...
  const handlePhoneSubmit = async () => {
    ...
    try {
      ...
      recaptchaVerifierRef.current = firebaseAuthService.createRecaptchaVerifier('recaptcha-container-login', 'normal')
      ...
      const confirmation = await firebaseAuthService.signInWithPhone(formattedPhone, recaptchaVerifierRef.current)
  ...
  const isProgressStep = step > 1 && authMethod === 'phone'
  const progressInfo = isProgressStep
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="text-white font-medium">Sign in with Phone</span>
                </button>
                ...
                >
                  ...
                  <span className="text-white font-medium">Sign in with Email</span>
                </button>
