...
import { FiArrowLeft, FiUser, FiBell, FiEye, FiShield, FiHelpCircle, FiChevronRight } from 'react-icons/fi'
      ...
      <div className="max-w-md mx-auto px-4 pt-20 pb-10">
        <div className="space-y-3">
          {settingsOptions.map((option, index) => (
            <div key={index} className="bg-white/5 rounded-lg border border-white/10 shadow-xl p-4 flex items-center justify-between hover:bg-white/10 transition-all cursor-pointer">
