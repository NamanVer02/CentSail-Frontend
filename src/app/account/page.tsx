...
export default function AccountPage() {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      const result = await authService.deleteAccount(idToken)
      
      if (result.success) {
        toast.success(result.message || 'Account deletion initiated. Your data will be permanently deleted after 7 days.')
    ...
    <div className="min-h-screen w-full text-white relative">
      ...
      <div className="max-w-md mx-auto px-4 pt-28 pb-24 relative z-10">
        ...
        <button 
          ...
          className="w-full bg-red-500/80 hover:bg-red-500 text-white font-semibold py-3 rounded-lg flex items-center justify-center transition-colors mb-4"
        >
        ...
        <button 
          ...
          className="w-full bg-red-600/60 hover:bg-red-600/80 text-white font-semibold py-3 rounded-lg flex items-center justify-center transition-colors border border-red-500/30"
        >
          ...
          <div className="w-full bg-black/30 backdrop-blur-md text-white rounded-t-2xl md:rounded-2xl md:max-w-md border-t border-x md:border border-white/10 shadow-2xl p-6">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                <p className="text-sm text-red-300 font-semibold mb-2">What will be deleted:</p>
                <ul className="text-sm text-white/70 space-y-1 list-disc list-inside">
                  <li>All your transactions and entries</li>
                  <li>All your custom categories</li>
                  <li>Your account profile</li>
                </ul>
                <p className="text-sm text-white/60 mt-3">
                  Your data will be permanently deleted after 7 days. You can contact support within this period to restore your account.
                </p>
              </div>
            </div>
